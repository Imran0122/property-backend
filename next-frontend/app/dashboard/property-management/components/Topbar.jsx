  ...
  return (
    <div className="bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a className="text-sm text-gray-500" href="#">Aller sur Hectare.ma</a>
          <button className="px-3 py-1 border rounded-md text-sm text-gray-700">Mes annonces</button>
          <button className="px-3 py-1 bg-green-600 text-white rounded-md text-sm">Publier une annonce</button>
