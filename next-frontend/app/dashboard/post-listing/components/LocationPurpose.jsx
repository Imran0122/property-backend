        ...
        <div className="col-span-12 md:col-span-9">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-3">
              <button className="px-3 py-2 rounded-full border bg-white text-gray-700">Maison</button>
              <button className="px-3 py-2 rounded-full border bg-white text-gray-700">Appartement</button>
              <button className="px-3 py-2 rounded-full border bg-white text-gray-700">Partie supérieure</button>
              <button className="px-3 py-2 rounded-full border bg-white text-gray-700">Partie inférieure</button>
              <button className="px-3 py-2 rounded-full border bg-white text-gray-700">Ferme</button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {!city && <p className="text-xs text-red-500 mt-1">Veuillez sélectionner une ville</p>}
            </div>
          ...
          <div className="mt-4 bg-gray-50 rounded-md h-36 flex items-center justify-center border border-dashed border-gray-200">
            <button className="text-sm bg-white border rounded px-3 py-2">Définir l’emplacement sur la carte</button>
          </div>
        </div>
      </div>
    </section>
