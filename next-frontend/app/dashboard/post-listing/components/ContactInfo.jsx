    ...
    <section className="bg-white rounded-lg shadow p-6">
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-3 flex items-start">
          ...
          <div className="ml-3 hidden md:block"><p className="text-sm text-gray-600">Informations de contact</p></div>
        </div>
        <div className="col-span-12 md:col-span-9 space-y-3">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <select className="border rounded px-3 py-2 w-24"> <option>+212</option></select>
